...
public class CheckSpamService
{
	...
	// will not work as of 4-1-21 until 'Post' has a userId attached to it
	/*
	...
	*/
	...
	// check comment with other comments of that post id
	public bool CheckCommentSpam(Comment comment)
    {
		return true;
    }
