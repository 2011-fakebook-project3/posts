...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fakebook.Posts.DataAccess.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Content = "Nice",
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 4, 16, 15, 27, 34, 251, DateTimeKind.Unspecified).AddTicks(7877), new TimeSpan(0, -4, 0, 0, 0)),
                            PostId = 1,
            ...
            modelBuilder.Entity("Fakebook.Posts.DataAccess.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 4, 16, 15, 27, 34, 247, DateTimeKind.Unspecified).AddTicks(7124), new TimeSpan(0, -4, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 4, 16, 15, 27, 34, 250, DateTimeKind.Unspecified).AddTicks(5678), new TimeSpan(0, -4, 0, 0, 0)),
                            UserEmail = "testaccount@gmail.com"
                        });
                });
            ...
            modelBuilder.Entity("Fakebook.Posts.DataAccess.Models.Comment", b =>
                {
                    b.HasOne("Fakebook.Posts.DataAccess.Models.Post", null)
                        .WithMany("Comments")
